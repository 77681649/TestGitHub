 ...
 *
 * @param {String} name model name model的名称
 * @param {Schema} [schema] 模式
 * @param {String} [collection] name (optional, induced from model name) Mongo集合的名称
 * @param {Boolean} [skipInit] whether to skip initialization (defaults to false) 支持给Model 传递options
 * @param {Object} options { cache , pluralization , connection }
 * @api public
 */
...
Mongoose.prototype.model = function(name, schema, collection, skipInit) {
  ...
  if (this.models[name] && false !== options.cache) {
    if (schema instanceof Schema && 
      schema != this.models[name].schema) {
